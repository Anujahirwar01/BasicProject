...
const Header = () => {
  ...
  />
  <span className="text-xl font-semibold text-orange-500 ">StackZone</span>

</Link>


          <Link to="/" className="text-black font-medium hover:bg-gray-200 rounded">About</Link>
          <Link to="/" className="text-black font-medium hover:bg-gray-200 rounded">Products</Link>
          <Link to="/" className="text-black font-medium hover:bg-gray-200 rounded">For Teams</Link>
        </div>
